...
1. [ ] Both MLS platforms have adapters implemented
...
4. [ ] All adapters have source configs created in `configs/sources/` with appropriate configuration
5. [ ] All adapters registered in `src/ingestion/registry.py`
