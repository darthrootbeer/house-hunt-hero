...
class CraigslistOwnerAdapter(IngestionAdapter):
    """Fetches FSBO housing listings from Craigslist SF Bay Area."""

    source_id = "craigslist_owner"
    # Real estate by owner in SF Bay Area
    SEARCH_URL = "https://sfbay.craigslist.org/search/rea#search=1~gallery~0~0"
            ...
            with sync_playwright() as p:
                ...
                for item in items[:25]:  # Limit to first 25 listings
                    try:
                        ...
                        # Get price if available (look for price in the card)
