...
class TruliaAdapter(IngestionAdapter):
    """Fetches listings from Trulia (Maine).
    
    Note: Trulia (owned by Zillow) has anti-bot measures similar to Zillow.
    """

    source_id = "trulia"
    BASE_URL = "https://www.trulia.com"
    # Maine for-sale listings
    SEARCH_URL = "https://www.trulia.com/ME/"
    ...
    def fetch(self) -> List[RawListing]:
        ...
        try:
            with sync_playwright() as p:
                ...
                # Trulia uses property cards
                items = page.query_selector_all("[data-testid='property-card'], li[class*='Grid__CellBox']")
                ...
                for item in items[:100]:
                    try:
                        ...
                        title = "Property"
                        try:
                            address_elem = item.query_selector("[data-testid='property-address'], [class*='Text__TextBase']")
                            if address_elem:
