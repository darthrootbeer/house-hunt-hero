...
class SwanAgencyAdapter(IngestionAdapter):
    """Fetches listings from Swan Agency Real Estate (swanagency.com)."""

    source_id = "swan_agency"
    BASE_URL = "https://swanagency.com"
    SEARCH_URL = "https://swanagency.com/listings/"
            ...
            with sync_playwright() as p:
                ...
                for item in items[:100]:
                    try:
                        ...
                        title = title_el.inner_text().strip() if title_el else "Swan Agency Property"
