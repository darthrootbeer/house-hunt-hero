...
class TheRockFoundationAdapter(IngestionAdapter):
    """Fetches FSBO listings from The Rock Foundation (therockfoundation.com)."""

    source_id = "the_rock_foundation"
    # Maine listings
    SEARCH_URL = "https://www.therockfoundation.com/search?state=ME"
            ...
            with sync_playwright() as p:
                ...
                for item in items[:50]:
                    try:
                        ...
                        if url.startswith("/"):
                            url = f"https://www.therockfoundation.com{url}"
