...
class FlatFeeGroupAdapter(IngestionAdapter):
    """Fetches FSBO listings from Flat Fee Group (flatfeegroup.com)."""

    source_id = "flat_fee_group"
    # Maine listings
    SEARCH_URL = "https://www.flatfeegroup.com/Maine"
            ...
            with sync_playwright() as p:
                ...
                for item in items[:50]:
                    try:
                        ...
                        if url.startswith("/"):
                            url = f"https://www.flatfeegroup.com{url}"
