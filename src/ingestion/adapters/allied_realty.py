...
class AlliedRealtyAdapter(IngestionAdapter):
    """Fetches listings from Allied Realty (alliedrealty.net)."""

    source_id = "allied_realty"
    BASE_URL = "https://alliedrealty.net"
    SEARCH_URL = "https://alliedrealty.net/listings/"
            ...
            with sync_playwright() as p:
                ...
                for item in items[:100]:
                    try:
                        ...
                        title = title_el.inner_text().strip() if title_el else "Allied Realty Property"
