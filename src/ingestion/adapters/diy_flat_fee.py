...
class DIYFlatFeeAdapter(IngestionAdapter):
    """Fetches FSBO listings from DIY Flat Fee MLS (diyflatfee.com)."""

    source_id = "diy_flat_fee"
    # Maine listings
    SEARCH_URL = "https://www.diyflatfee.com/search?state=ME"
            ...
            with sync_playwright() as p:
                ...
                for item in items[:50]:
                    try:
                        ...
                        if url.startswith("/"):
                            url = f"https://www.diyflatfee.com{url}"
