...
class ISoldMyHouseAdapter(IngestionAdapter):
    """Fetches FSBO listings from ISoldMyHouse.com."""

    source_id = "isold_my_house"
    # Maine listings
    SEARCH_URL = "https://www.isoldmyhouse.com/search?state=ME"
            ...
            with sync_playwright() as p:
                ...
                for item in items[:50]:
                    try:
                        ...
                        if url.startswith("/"):
                            url = f"https://www.isoldmyhouse.com{url}"
