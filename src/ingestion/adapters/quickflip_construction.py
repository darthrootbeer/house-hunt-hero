...
class QuickFlipConstructionAdapter(IngestionAdapter):
    """Fetches investment/wholesale property listings from QuickFlip Construction."""

    source_id = "quickflip_construction"
    SEARCH_URL = "https://www.quickflipconstruction.com"
        ...
        try:
            with sync_playwright() as p:
                ...
                items = page.query_selector_all(
                    ...
                    "[class*='deal'], .investment-property, [class*='investment']"
                )
                ...
                for item in items[:50]:
                    try:
                        ...
                        if url.startswith("/"):
                            url = f"https://www.quickflipconstruction.com{url}"
