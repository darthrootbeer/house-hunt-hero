...
class TheMaineAgentsAdapter(IngestionAdapter):
    """Fetches listings from The Maine Agents (themaineagents.com)."""

    source_id = "the_maine_agents"
    BASE_URL = "https://themaineagents.com"
    SEARCH_URL = "https://themaineagents.com/listings/"
            ...
            with sync_playwright() as p:
                ...
                for item in items[:100]:
                    try:
                        ...
                        title = title_el.inner_text().strip() if title_el else "The Maine Agents Property"
