...
class MotivateMaineAdapter(IngestionAdapter):
    """Fetches wholesale/off-market property listings from Motivate Maine (Wholesale Network)."""

    source_id = "motivate_maine"
    SEARCH_URL = "https://www.motivatemaine.com"
    ...
    def fetch(self) -> List[RawListing]:
        ...
        try:
            with sync_playwright() as p:
                ...
                # Look for wholesale/off-market property listings
                items = page.query_selector_all(
                    ".property, .listing, .deal, .wholesale, [class*='property'], "
                    "[class*='listing'], [class*='deal'], [class*='wholesale'], .off-market"
                )
                ...
                for item in items[:50]:
                    try:
                        ...
                        if url.startswith("/"):
                            url = f"https://www.motivatemaine.com{url}"
