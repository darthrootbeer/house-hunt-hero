...
class AdvertiserDemocratAdapter(IngestionAdapter):
    """Fetches real estate listings from Advertiser Democrat classifieds (Greater Oxford Hills, Maine)."""

    source_id = "advertiser_democrat"
    # Try common newspaper classifieds URL patterns
    SEARCH_URL = "https://www.advertiserdemocrat.com/classifieds/real-estate"
        ...
        try:
            with sync_playwright() as p:
                ...
                items = page.query_selector_all(
                    ...
                    ".classified-item, article, .classified"
                )

                if not items:
                    items = page.query_selector_all("a[href*='/real-estate'], a[href*='/classifieds']")
                ...
                for item in items[:50]:
                    try:
                        ...
                        if url.startswith("/"):
                            url = f"https://www.advertiserdemocrat.com{url}"
