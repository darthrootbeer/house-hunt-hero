...
class SargentRealEstateAdapter(IngestionAdapter):
    """Fetches listings from Sargent Real Estate (sargentre.com)."""

    source_id = "sargent_real_estate"
    BASE_URL = "https://sargentre.com"
    SEARCH_URL = "https://sargentre.com/listings/"
            ...
            with sync_playwright() as p:
                ...
                for item in items[:100]:
                    try:
                        ...
                        title = title_el.inner_text().strip() if title_el else "Sargent Real Estate Property"
