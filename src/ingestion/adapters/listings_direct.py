...
class ListingsDirectAdapter(IngestionAdapter):
    """Fetches listings from Listings Direct (listingsdirectme.com)."""

    source_id = "listings_direct"
    BASE_URL = "https://listingsdirectme.com"
    SEARCH_URL = "https://listingsdirectme.com/search/"
            ...
            with sync_playwright() as p:
                ...
                for item in items[:100]:
                    try:
                        ...
                        title = title_el.inner_text().strip() if title_el else "Listings Direct Property"
