...
class LocationsRealEstateGroupAdapter(IngestionAdapter):
    """Fetches listings from Locations Real Estate Group (locationsinmaine.com)."""

    source_id = "locations_real_estate_group"
    BASE_URL = "https://locationsinmaine.com"
    SEARCH_URL = "https://locationsinmaine.com/listings/"
            ...
            with sync_playwright() as p:
                ...
                for item in items[:100]:
                    try:
                        ...
                        title = title_el.inner_text().strip() if title_el else "Locations Real Estate Group Property"
