...
class MaineHighlandsFCUAdapter(IngestionAdapter):
    """Fetches property listings from Maine Highlands Federal Credit Union (mhfcu.com)."""

    source_id = "maine_highlands_fcu"
    BASE_URL = "https://mhfcu.com"
    # Try common property listing URLs
    SEARCH_URLS = [
        "https://mhfcu.com/properties/",
        "https://mhfcu.com/properties-for-sale/",
        "https://mhfcu.com/real-estate/",
    ]
            ...
            with sync_playwright() as p:
                ...
                for search_url in self.SEARCH_URLS:
                    try:
                        ...
                        items = page.query_selector_all(
                            ...
                            ".property-list .property, .properties .property"
                        )
                        ...
                        if items:
                            # Found listings, break and process
                            break
                    except Exception:
                        continue
                ...
                for item in items[:100]:
                    try:
                        ...
                        title = title_el.inner_text().strip() if title_el else "Maine Highlands FCU Property"
