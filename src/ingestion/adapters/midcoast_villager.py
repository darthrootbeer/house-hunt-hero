...
class MidcoastVillagerAdapter(IngestionAdapter):
    """Fetches real estate listings from Midcoast Villager classifieds (Knox and Waldo counties, Maine)."""

    source_id = "midcoast_villager"
    # Try common newspaper classifieds URL patterns
    SEARCH_URL = "https://www.midcoastvillager.com/classifieds/real-estate"
            ...
            with sync_playwright() as p:
                ...
                for item in items[:50]:
                    try:
                        ...
                        if url.startswith("/"):
                            url = f"https://www.midcoastvillager.com{url}"
