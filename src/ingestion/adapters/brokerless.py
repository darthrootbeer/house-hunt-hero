...
class BrokerlessAdapter(IngestionAdapter):
    """Fetches FSBO listings from Brokerless (brokerless.com)."""

    source_id = "brokerless"
    # Search for Maine listings
    SEARCH_URL = "https://www.brokerless.com/search?state=ME"
    ...
    def fetch(self) -> List[RawListing]:
        ...
        try:
            with sync_playwright() as p:
                ...
                if not items:
                    items = page.query_selector_all("a[href*='/property'], a[href*='/listing'], a[href*='/home']")
                ...
                for item in items[:50]:
                    try:
                        ...
                        if url.startswith("/"):
                            url = f"https://www.brokerless.com{url}"
