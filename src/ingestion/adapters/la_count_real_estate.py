...
class LaCountRealEstateAdapter(IngestionAdapter):
    """Fetches listings from La Count Real Estate (maineliving.com)."""

    source_id = "la_count_real_estate"
    BASE_URL = "https://maineliving.com"
    SEARCH_URL = "https://maineliving.com/listings/"
            ...
            with sync_playwright() as p:
                ...
                for item in items[:100]:
                    try:
                        ...
                        title = title_el.inner_text().strip() if title_el else "La Count Real Estate Property"
