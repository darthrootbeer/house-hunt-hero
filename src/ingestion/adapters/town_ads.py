...
class TownAdsAdapter(IngestionAdapter):
    """Fetches real estate listings from Town-Ads.com classifieds (Maine)."""

    source_id = "town_ads"
    # Maine real estate/housing section
    SEARCH_URL = "https://www.town-ads.com/-19-maine/housing-real-estate"
        ...
        try:
            with sync_playwright() as p:
                ...
                items = page.query_selector_all(
                    ...
                    ".classified-item, article"
                )

                if not items:
                    items = page.query_selector_all("a[href*='/housing'], a[href*='/real-estate']")
                ...
                for item in items[:50]:
                    try:
                        ...
                        if url.startswith("/"):
                            url = f"https://www.town-ads.com{url}"
